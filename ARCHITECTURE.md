...
| `lpf_simulation.py` | Monte Carlo puro para zona, suma de puntos y objetivos; recibe fuerza/contexto por parámetro. |
...
10. **Monte Carlo (`lpf_simulation`):** recibe fuerza, fixture/contexto y semilla explícitos para producir posiciones, puntos y máscaras de objetivo sin conocer Streamlit.
