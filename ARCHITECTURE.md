...
| `lpf_simulation.py` | Monte Carlo puro y constructor explícito de contexto: Anual/cupos, zona, suma de puntos y objetivos; recibe todas las fotos por parámetro. |
...
- El contexto Monte Carlo se arma en `lpf_simulation.build_simulation_context`: Apertura, Anual directa, cupos/reemplazos, promedios y rest entran por parámetro; una API no necesita reproducir fallbacks de sesión.
